...
class HistoryHelpWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
        ...
        child: Row(
          ...
          children: <Widget>[
            Flexible(
              fit: FlexFit.tight,
              child: Center(
                child: Text(HistoryStrings.HELP_DIALOG_TITLE, style: FinanzappStyles.commonTextStyle3, textAlign: TextAlign.center),
              ),
            ),
            GestureDetector(
              onTap: (){
      ...
      content: Container(
        ...
        child: Center(
          child: Text(HistoryStrings.HELP_DIALOG_CONTENT, style: FinanzappStyles.commonTextStyle1, textAlign: TextAlign.justify,),
        ),
      ),
    );
  }
