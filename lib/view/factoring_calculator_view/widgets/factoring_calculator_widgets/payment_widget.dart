...
class PaymentWidget extends StatelessWidget {
  ...
  const PaymentWidget({Key key, this.payment, this.deleteAtFun, this.index}) : super(key: key);
        ...
        children: <Widget>[
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(hintText: FactoringCalculatorStrings.PAYMENT_HINT),
            ),
          ),
          Flexible(
            child: Container(
